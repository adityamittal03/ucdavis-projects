...
To reproduce the analysis, view the PDF report at `reports/song_popularity_report.pdf` or open the R Markdown file (`spotify_popularity_analysis.Rmd`) in RStudio and knit it to HTML or PDF.